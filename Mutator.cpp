...
//	std::ifstream source(reference, std::ios_base::binary);
//	std::ifstream mutation(probe, std::ios_base::binary);
//	while (source) {
...
//		distance += Popcnt8[static_cast<int>(x) & static_cast<int>(y)];
//		maxpossible += 8;
//	}
//	return float(distance/maxpossible);
//}
